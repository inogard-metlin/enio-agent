...
@RestController
@RequestMapping(value = {"/items", "/agent/v1/items"},
...
public class ItemRestController {
  ...
  public DataTablesOutput<ItemDto.Response> getItems(@Valid ItemDto.Search search,
      @Valid DataTablesInput input) {
    return itemService.getAllItems(search, input);
  }

  @RequestMapping(method = RequestMethod.GET)
  @ResponseStatus(HttpStatus.OK)
  @JsonView(ItemDto.Views.PublicView.class)
  public PageImpl<ItemDto.Response> getItems(@Valid ItemDto.Search search, Pageable pageable) {
    Page<Item> page = itemService.getAllItems(search, pageable);
