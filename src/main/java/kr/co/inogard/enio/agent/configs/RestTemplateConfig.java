...
import kr.co.inogard.enio.agent.commons.handler.EnioResponseErrorHandler;
...
public class RestTemplateConfig {
	...
	@Bean
	public RestTemplate restTemplateCustomizer(EnioJsonHttpMessageConverter enioJsonHttpMessageConverter,
			ClientHttpRequestInterceptor restTemplateInterceptor, EnioResponseErrorHandler enioResponseErrorHandler,
			AgentConfig agentConfig) {

		CloseableHttpClient client = HttpClientBuilder.create()
				.setDefaultCredentialsProvider(
						provider(agentConfig.getAgent().getAgtCd(), agentConfig.getAgent().getRawLicenceKey()))
