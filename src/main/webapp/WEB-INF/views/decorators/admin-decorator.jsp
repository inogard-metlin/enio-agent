...
<html lang="ko">
  <head>
    ...
    <link href="/webjars/gentelella/1.4.0/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    <!-- Page Head -->
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title"><i class="fa fa-paper-plane"></i> <span>ENIO AGENT</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-paper-plane-o"></i> 송신 내역 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/send/items">물품</a></li>
                      <li><a href="/send/pr">구매요청</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-server"></i> 수신 내역 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="/items">물품</a></li>
                      <li><a href="/pr">구매요청</a></li>
                      <li><a href="/bid/rfq">입찰</a></li>
                      <li><a href="/po">계약</a></li>
                    </ul>
                  </li>
    ...
    <!-- bootstrap-daterangepicker -->
    <script src="/webjars/gentelella/1.4.0/vendors/moment/min/moment.min.js"></script>
    <script src="/webjars/gentelella/1.4.0/vendors/moment/min/locales.min.js"></script>
    <script src="/webjars/gentelella/1.4.0/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
