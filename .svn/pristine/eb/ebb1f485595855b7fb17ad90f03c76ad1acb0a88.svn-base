    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>구매요청 <small>구매요청 송신 내역입니다.</small></h2>
            ...
            <div class="x_content">
              ...
              <table id="tblSendPr" class="table table-striped table-bordered table-hover" style="width: 100%">
                <thead>
                  <tr>
                    <th></th>
                    <th>ERP구매요청번호</th>
  ...
  <script id="prDetailTmpl" type="text/x-jsrender">
    <div class="x_panel">
      ...
      <div id="wrapSendPrItems">
        ...
        <table id="tblSendPrItems" class="table table-striped table-bordered table-hover" style="width: 100%">
          <thead>
            <tr>
              <th>ERP구매요청번호</th>
              <th>품목순번</th>
      ...
      <div id="wrapSendPrServices">
        ...
        <table id="tblSendPrServices" class="table table-striped table-bordered table-hover" style="width: 100%">
          <thead>
            <tr>
              <th>ERP구매요청번호</th>
              <th>품목순번</th>
      ...
      <table id="tblSendPrFiles" class="table table-striped table-bordered table-hover" style="width: 100%">
        <thead>
          <tr>
            <th>ERP구매요청번호</th>
            <th>순번</th>
          ...
          load: function() {
            var dtSendPr = (function() {
              ...
              var _format = function(d) {
                ...
                var reqSendPr = $.ajax("/send/pr/" + d.erpPrNo, {
                  dataType: "json"
                });
  
                reqSendPr.then(function(data) {
                  ...
                  return $.ajax("/send/pr/" + d.erpPrNo + "/items", {
                    dataType: "json"
                  });
                }).then(function(data) {
                  console.log("Request Pr Items Done");
                  dtSendPrItems.init($htmlOutput.find("#tblSendPrItems"), {
                    data: data
                  });
  
                  var reqSendPrServices = null;
                  if (d.prTypecd !== "N") {
                    reqSendPrServices = $.ajax("/send/pr/" + d.erpPrNo + "/items/" + data[0].itemSeq + "/services", {
                      dataType: "json"
                    });
                  }
  
                  return $.when(reqSendPrServices);
                }).then(function(data) {
                  console.log("Request Pr Services Done");
                  if (data !== null) {
                    dtSendPrServices.init($htmlOutput.find("#tblSendPrServices"), {
                      data: data
                    });
                  }
                  return $.ajax("/send/pr/" + d.erpPrNo + "/files", {
                    dataType: "json"
                  });
                }).done(function(data) {
                  console.log("Request Pr Files Done");
                  dtSendPrFiles.init($htmlOutput.find("#tblSendPrFiles"), {
                    data: data
                  });
            ...
            var dtSendPrItems = (function() {
              var $dataTable = null;
              var init = function(table, opt) {
                var $table = table ? table : $("#tblSendPrItems");
                var settings = {
                  lengthChange: false,
                  paging: false,
                  searching: false,
            ...
            var dtSendPrServices = (function() {
              var $dataTable = null;
              var init = function(table, opt) {
                var $table = table ? table : $("#tblSendPrServices");
                var settings = {
                  lengthChange: false,
                  paging: false,
                  searching: false,
            ...
            var dtSendPrFiles = (function() {
              var $dataTable = null;
              var init = function(table, opt) {
                var $table = table ? table : $("#tblSendPrFiles");
                var settings = {
                  lengthChange: false,
                  paging: false,
                  searching: false,
                  ...
                  columns: [{
                    ...
                    render: function(data, type, row, meta) {
                      var url = "/send/pr/" + row.erpPrNo + "/files/" + row.fileSeq;
