...
import kr.co.inogard.enio.agent.commons.filter.wrapper.CaptureRequestWrapper;
import kr.co.inogard.enio.agent.commons.filter.wrapper.CaptureResponseWrapper;
...
public class LoggingFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    Agent agt = ((AgentUserDetailsImpl) authentication.getPrincipal()).getAgent();
